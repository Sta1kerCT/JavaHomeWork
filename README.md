# JavaHomeWork
В этом репозитории хранятся все мои выполненные домашние задания с первого курса КТ ИТМО. Они разделены на пакеты, но для удобства я буду указывать коммит и пакет.
